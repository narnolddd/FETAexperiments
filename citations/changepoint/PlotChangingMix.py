...
file = "experiments/citations/changepoint/CPFitsMar20.dat"

# model a mixture of DegreePower 1.2, Triangle(11), and random attachment
...
ax.fill_between(stamps,0.001,DP,color='blue', alpha=0.7)
ax.fill_between(stamps,DP,DP + Tri,color='green', alpha=0.7)
ax.fill_between(stamps,DP+Tri,DP+Rand+Tri, color='red', alpha=0.7)
...
plt.tight_layout()
plt.savefig("experiments/citations/changepoint/CitationMixtures.pdf")
plt.show()