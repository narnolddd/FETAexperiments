...
for model in models:
    ...
    ax[1,0].plot(times, averages['clustercoeff'],label=label, linestyle=complinestyle[model], linewidth=compthickness[model], alpha=compalpha)
    ax[0,1].plot(times, averages['meandegsq'], label=label, linestyle=complinestyle[model], linewidth=compthickness[model], alpha=compalpha)
    ax[3,0].plot(times, averages['assortativity'], label=label, linestyle=complinestyle[model], linewidth=compthickness[model], alpha=compalpha)
    ax[2,0].plot(times, averages['singletons'], label=label, linestyle=complinestyle[model], linewidth=compthickness[model], alpha=compalpha)
    ax[2,1].plot(times, averages['doubletons'], label=label, linestyle=complinestyle[model], linewidth=compthickness[model], alpha=compalpha)
    ax[1,1].plot(times, averages['triangles'], label=label, linestyle=complinestyle[model], linewidth=compthickness[model], alpha=compalpha)
...
plt.savefig("/Users/narnolddd/Documents/PhDMAIN/NaomiThesis/plots/fb_comparisons_2.pdf")
plt.show()
