...
realdata = root+"RealMeasurements.dat"
...
mixturefiles = ["DP0.8RandTri15Measurements.dat"]
componentfiles = ["DP0.8Measurements.dat", "Tri15Measurements.dat", "RandMeasurements.dat"]
mixnames = [m.strip("Measurements.dat") for m in mixturefiles]
compnames = [c.strip("Measurements.dat") for c in componentfiles]
...
mixlabel = "0.61 DP (0.8), 0.06 Tri (15), 0.33 Rand"
